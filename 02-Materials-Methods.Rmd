...
```{r out.width = "70%", fig.align='center', fig.cap="(ref:Craniotomy-capture)", label="Craniotomy", echo=FALSE}
...
```{r out.width = "80%", fig.align='center', fig.cap="(ref:TexExamples-capture)", label="TexExamples", echo=FALSE}
...
```{r out.width = "90%", fig.align='center', fig.cap="(ref:OurStim-capture)", label="OurStim", echo=FALSE}
...
```{r out.width = "90%", fig.align='center', fig.cap="(ref:RFstim-capture)", label="RFstim", echo=FALSE}
